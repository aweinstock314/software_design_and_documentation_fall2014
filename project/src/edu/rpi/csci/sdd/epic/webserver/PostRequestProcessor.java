...
public abstract class PostRequestProcessor implements HttpHandler
{
    ...
    // parseCheckbox is a convenience method for converting the strings 
    // that HTML checkboxes "return" into easy-to-use booleans
    ...
    public void handle(HttpExchange e) throws IOException
    {
        ...
        try
        {
            // serve the page generated by the subclass
