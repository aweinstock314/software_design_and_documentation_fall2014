...
33	Some+event	RPI	this+form	not yet implemented	f	1969-12-31 19:00:00	1969-12-31 19:00:00	here	f
34	alpha	beta	gamma	not yet implemented	t	2001-09-08 00:00:00	33658-09-26 00:00:00	delta	f
\.
...
qwerty	hello
qwerty	world
qwerty	<script>alert("xss test");</script>
username	e
username	abc
username	ghi
username	
username	<script>alert('hello, world!');</script>
username	Is a sentence fragment
\.
...
DUMMY_VALUE	f	username%40example.com	username	password
null	f	null	this_is_a_test	password
DUMMY_VALUE	f	foo%40example.com	user4	pass4
DUMMY_VALUE	f	foo%40example.com	user4	pass4
DUMMY_VALUE	f	foo%40example.com	user4	pass5
DUMMY_VALUE	f	foo%40example.com	user4	pass6
DUMMY_VALUE	t	foo%40example.com	user4	pass7
DUMMY_VALUE	t	example%40example.com	qwerty	uiop
\N	t	\N	hello	world
\N	t	\N	%5C%27foo	passthingy
\.
